import 'package:dzikir_app/TampilPagi.dart';
import 'package:dzikir_app/TampilPetang.dart';
import 'package:dzikir_app/TampilTentang.dart';
...
//              color: Colors.blue,
            ...
            GestureDetector(
              onTap: () {
                openNewSreen(context, TampilPetang());
              },
              child: Container(
//                color: Colors.blue,
                padding: EdgeInsets.symmetric(horizontal: 30.0, vertical: 15.0),
